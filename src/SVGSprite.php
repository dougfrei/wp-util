...
class SVGSprite
{
	...
	*/
	public function get_symbols_array($opts = [])
	{
	...
	*/
	public function get_svg_symbol($icon, $opts = [])
	{
	...
	*/
	public function the_svg_symbol($icon, $opts = [])
	{
	...
	protected function register_use_handler()
	{
		...
		add_action('wp_footer', [&$this, 'svg_use_handler']);
